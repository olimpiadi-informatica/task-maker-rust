...
pub struct IOITestcaseInfo {
    ...
    /// The path to the input file if it's not generated by a generator.
    pub static_input: Option<PathBuf>,
    /// The path to the output file if it's not generated by a solution.
    pub static_output: Option<PathBuf>,
